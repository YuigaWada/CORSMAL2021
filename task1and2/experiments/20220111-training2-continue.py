...
if __name__ == "__main__":
    ...
    for step in range(EPOCH):
        ...
        if min_val_loss_sum_t1_t2 > val_loss_t1[-1] + val_loss_t2[-1]:
            ...
            torch.save(model.state_dict(), current_dir / "20220111-result2-continue.pt")
    ...
    plt.legend()
    plt.savefig(str(current_dir / "20220111-result2-continue.png"))
