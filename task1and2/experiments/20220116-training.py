...
# ```
# :
# {'train loss': 0.02450929670881747, 'train accuracy': 0.9917355371900827, \
#   'val loss': 1.0682659815168505, 'val accuracy': 0.782051282051282}
# {'train loss': 0.041585838291785186, 'train accuracy': 0.9900826446280991, \
#   'val loss': 0.09162802699120813, 'val accuracy': 0.9487179487179487}
# {'train loss': 0.009886831904770785, 'train accuracy': 0.9983471074380166, \
#   'val loss': 1.12922323835822, 'val accuracy': 0.7692307692307693}
# {'train loss': 0.03800973328996259, 'train accuracy': 0.9900826446280991, \
#   'val loss': 0.20917523923888454, 'val accuracy': 0.9230769230769231}
# {'train loss': 0.01241650842267824, 'train accuracy': 0.996694214876033, \
#   'val loss': 1.0808763286992695, 'val accuracy': 0.7948717948717948}
# best (val_loss_t1, val_loss_t2) pair is (0.09247682583154179, 0.3331974793974764)!
# then (val_acc_t1, val_acc_t2) pair is (0.9615384615384616, 0.8461538461538461)!
# ```
